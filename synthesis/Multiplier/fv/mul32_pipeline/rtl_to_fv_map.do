...
# Generated on: Fri Jun 05 09:53:37 IST 2026 (Fri Jun 05 04:23:37 UTC 2026)
...
set_log_file fv/mul32_pipeline/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/mul32_pipeline -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  mul32pipe.v
elaborate_design -golden -root {mul32_pipeline} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/mul32_pipeline/fv_map.v.gz
elaborate_design -revised -root {mul32_pipeline}
...
#add_name_alias fv/mul32_pipeline/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/mul32_pipeline/rtl_to_fv_map.log
}
